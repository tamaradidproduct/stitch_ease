...
const LENORE_PHASES = [
  ...
  },
  {
    ...
    steps:[
      ...
      {id:'r2-de', text:'Ring D – Chain E (repeat unit):',
        bullets:[
          'Ring D: 2 - 2 + 2 + 2 - 2 (join to Ring B, join to a Ring Q of Row 1)',
          'Chain E: 2 - 2 - 2 - 2',
        ],
        rows:true, target:11, lbl:'repeat: Ring D – Chain E'},
      {id:'r2-d2', text:'Ring D: 2 - 2 + 2 + 2 - 2 (join to a Ring Q of Row 1) — final repeat, no Chain E after this one'},
      ...
      {id:'r2-nopqrs', text:'Ring N – Chain S (repeat unit):',
        bullets:[
          'Ring N: 2 + 2 - 2 - 2 (join to Ring L, or to the previous repeat)',
        ...
        rows:true, target:4, lbl:'repeat: Ring N – Chain S'},
      {id:'r2-n2', text:'Ring N: 2 + 2 - 2 - 2 (join to the previous repeat) — final repeat, no Chain O–S after this one'},
