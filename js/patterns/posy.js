...
PATTERNS.push(
  { id:'posy', name:'Posy', badge:'Size XS · 94cm chest', desc:'Cropped V-neck cardigan · lace lower body & upper back', phases: POSY_PHASES,
    notes: [
      ...
      { term:'Yarn over', def:'Wrap the yarn to create a new stitch and an eyelet.', sym:'YO' },
      ...
      { term:'tssk', def:'Twisted ssk — insert the right needle from right to left into the next 2 sts and knit them together.', sym:'TSSK' },
      { term:'tk2tog', def:'Twisted k2tog — slip 2 sts knitwise one at a time, slip them back to the left needle, then knit them together through the back loop.', sym:'TK2TOG' },
      ...
      { term:'m1rp', def:'Make one right, purlwise — the WS-row symbol.', sym:'M1RP' },
      ...
      { term:'m1lp', def:'Make one left, purlwise — the WS-row symbol.', sym:'M1LP' },
      { term:'sl2-k1-p2sso', def:'Central double decrease — slip 2 sts together knitwise, k1, pass the 2 slipped sts over.', sym:'CDD' },
